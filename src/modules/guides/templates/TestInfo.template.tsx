    ...
    <main className={`${style.page} flex flex-col gap-5 items-start`}>
      <div className="flex gap-5 w-full items-center">
        ...
        <div className="flex gap-5 items-center">
          <img src="/icons/list-icon.png" alt="list-icon" className="border-[3px] border-pink rounded-2xl h-[75px]"/>
      ...
      <div className="flex flex-col gap-6 w-full">
        <div className="flex flex-col gap-4">
          <div className="flex gap-4 items-center border border-neutral-300 rounded-2xl p-4">
            ...
            <p className="pr-10">{testData.features[0]}</p>
          </div>
          <div className="flex gap-4 items-center border border-neutral-300 rounded-2xl p-4">
            <img src="/icons/list-icon.png" alt="list-icon" />
            <p>{testData.features[1]}</p>
          </div>
          <div className="flex gap-4 items-center border border-neutral-300 rounded-2xl p-4">
            <img src="/icons/list-icon.png" alt="list-icon" />
            <p>{testData.features[2]}</p>
          </div>
        </div>
      </div>
    </div>
