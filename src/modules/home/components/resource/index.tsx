...
const Resource: React.FC<ResourceProps> = ({
  ...
  return (
    <div
      className={`bg-${color} rounded-2xl px-6 py-4 flex justify-between h-48 text-white relative shadow-sm ${shadowClass} hover:scale-105 transform transition-all hover:cursor-pointer`}
    >
