...
const Affiliation = ({ selectedSchool }: { selectedSchool: SchoolProps }) => {
  return (
    <div className="flex flex-col gap-5 p-5 bg-white rounded-3xl border border-neutral-200">
      <h3 className="text-lg small:text-xl font-bold tracking-wide pl-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-2 items-center">
          ...
          <p className="text-sm small:text-base font-semibold">{selectedSchool.sector}</p>
        </div>
        <div className="flex flex-col gap-2 items-center">
          ...
          <p className="text-sm small:text-base font-semibold">{selectedSchool.level}</p>
        </div>
        <div className="flex flex-col gap-2 items-center">
          ...
          <p className="text-sm small:text-base font-semibold">{selectedSchool.gender_2}</p>
        </div>
        <div className="flex flex-col gap-2 items-center">
          ...
          <p className="text-sm small:text-base font-semibold">{selectedSchool.religion}</p>
        </div>
      </div>
    </div>
  );
