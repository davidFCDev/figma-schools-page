...
const MedianScore = ({ selectedSchool }: { selectedSchool: SchoolProps }) => {
  return (
    <div className="w-full flex flex-col justify-between bg-white border border-neutral-200 rounded-2xl p-5 font-semibold">
      ...
      <div className="flex relative">
        ...
        <div className="flex flex-col bg-white border border-neutral-200 rounded-2xl absolute py-3 px-6 left-[14%] -top-8">
