...
const DropDown: React.FC<{ scholarship: ScholarshipProps }> = ({ scholarship }) => {
  return <div className="w-full rounded-3xl border-t border-neutral-200 shadow-b-xs shadow-neutral-200 flex flex-col gap-4 px-8 py-4">
